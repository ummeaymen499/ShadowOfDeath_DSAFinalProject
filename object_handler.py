...
class ObjectHandler: # Manages all NPC and static sprites
    def __init__(self, game):
        ...
        self.npc_positions = {} # A dictionary that tracks the positions of all NPCs

        # spawn npc
        self.enemies = 20  # npc count
        self.npc_types = [SoldierNPC, CacoDemonNPC, CyberDemonNPC]
        self.weights = [70, 20, 10] 
        self.restricted_area = {(i, j) for i in range(10) for j in range(10)} # Enemies cannot be placed randomly in such areas
        self.spawn_npc()
